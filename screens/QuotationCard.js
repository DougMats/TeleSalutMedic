      ...
      <View style={styles.wrapper}>
        ...
        {editing === true &&
          <View style={{ flexDirection: "row" }}>
            <TextInput value={Form.price} onChangeText={text => onChangeText(text, 'price')} style={{ color: colorIota, marginBottom: 10, backgroundColor: colorNi, width: "60%", borderRadius: 12, height: 40 }} placeholder="Precio" />
