...
function ClientView(props) {
  ...
  function goToQuotation(screen, code) {
    console.log("enviando: ", code)
    let from = "ClientView"
    props.navigation.navigate(screen, { randomCode: Math.random(), code, from})
  }
                      ...
                      return (
                        <View key={key} style={{ borderRightColor: colorBetta, borderRightWidth: 50, marginBottom: 15, shadowColor: "#000", shadowOffset: { width: 0, height: 2, }, shadowOpacity: 0.25, shadowRadius: 8.84, elevation: 5, borderRadius: 20, backgroundColor: "white", width: "90%", paddingHorizontal: 20, paddingVertical: 20 }}>
                          ...
                          */}
                          ...
                          {i.state === 3 &&
                            <TouchableOpacity onPress={() => goToQuotation("Quotation", i.id)} style={{ zIndex: 99999999, position: "absolute", bottom: 15, justifyContent: "center", alignContent: "center", alignItems: "center", right: -50, height: 40, width: 50, padding: 5, }}>
...
const styles = StyleSheet.create({
  ...
  label: { color: colorAlfa, fontSize: 14 },
  text: { color: "#777", fontSize: 16, fontWeight: "bold", marginBottom: 15 },

  hr: { width: "100%", borderBottomColor: "#eee", marginVertical: 10, borderBottomWidth: 1 }
});