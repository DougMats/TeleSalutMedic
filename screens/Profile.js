...
function Profile(props) {
  ...
  const [countClients, setcountClients] = useState(5);
  const [countQuotations, setcountQuotations] = useState(345);
  const iconUp = 25
  const iconLeft = 40
      ...
      <LinearGradient colors={[GB1, BG2]} style={styles.imageBackground}>
        <ScrollView>
          <View style={{ width: "100%", alignItems: "center", alignContent: "center", paddingBottom: 100 }}>
            ...
            {!Load &&
              <TouchableOpacity style={styles.card} onPress={() => goToScreen("AdminMeet")}>
                <View style={styles.card_icon}>
